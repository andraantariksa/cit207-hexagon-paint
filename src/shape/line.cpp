...
namespace shape
{
    ...
    Line::LineBuilder Line::LineBuilder::from(int x1, int y1)
    {
        this->x1 = x1;
        this->y1 = y1;
        return *this;
    ...
    Line::LineBuilder Line::LineBuilder::to(int x2, int y2)
    {
        this->x2 = x2;
        this->y2 = y2;
        return *this;
    ...
    Line::LineBuilder Line::LineBuilder::withColor(Color color)
    {
        this->color = color;
        return *this;
    }

    Line::LineBuilder Line::LineBuilder::withWidth(int width)
    {
        this->width = width;
        return *this;
    }

    Line::LineBuilder Line::LineBuilder::isDotted(bool is_dotted)
    {
    ...
    Line::Line(int x1, int y1, int x2, int y2, Color color, bool is_dotted, int width)
    {
        this->x1 = x1;
        this->y1 = y1;
        this->x2 = x2;
     ...
     Line::LineBuilder Line::from(int x1, int y1)
    {
        Line::LineBuilder line_builder;
        line_builder.from(x1, y1);
        return line_builder;
    }

     float Line::slope(int x1, int y1, int x2, int y2)
    {
